    ...
    var pager = {
        ...
        fillHtml : function(pageSpan, page) {
            return (function() {
                ...
                pageSpan.append('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;共<span>'+page.totalPage+'</span>页，跳至&nbsp;<input type="text" id="jumpNum" class="jumpPage" />&nbsp;页&nbsp;<a href="javascript:;" title="go" class="jumpBtn"><button class="jumpBtns">go</button></a>');
            })();
        },
        ...
        bindEvent : function(obj, page) {
            ...
            return (function() {
                ...
                //跳转
                obj.on('click','a.jumpBtn',function(){
                    var jumpNum=document.getElementById("jumpNum").value;
                    alert(jumpNum);
                    pager.fillHtml(obj,{"pageIndex":jumpNum,"totalPage":page.totalPage});
